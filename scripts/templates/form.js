  ...
  <div>
    ...
    <form id="post-form" action="/movies/${movie.id}">
      <div class="form-group">
        ...
        <input required type="text" class="form-control" id="movieTitle" aria-describedby="titleHelp" placeholder="Movie title" value="${movie.title}">
        <small id="titleHelp" class="form-text text-muted">Enter the title of the movie.</small>
      </div>
      <div class="form-group">
        <label for="movieDirector">Director</label>
        <input required type="text" class="form-control" id="movieDirector" aria-describedby="directorHelp" placeholder="Movie director" value="${movie.director}">
        <small id="directorHelp" class="form-text text-muted">Enter the director of the movie.</small>
      </div>
      <div class="form-group">
        <label for="yearReleased">Year</label>
        <input required type="text" class="form-control" id="yearReleased" aria-describedby="yearHelp" placeholder="Release year" value=${movie.year}>
      ...
      <div class="form-group">
        ...
        <input required type="text" class="form-control" id="yourRating" aria-describedby="ratingHelp" placeholder="Your rating" value=${movie.your_rating}>
        <small id="ratingHelp" class="form-text text-muted">On a scale of 1 to 5, how many stars do you give this movie?</small>
      </div>
      <div class="form-group">
        <label for="posterUrl">Poster URL</label>
        <input required type="text" class="form-control" id="posterUrl" aria-describedby="posterHelp" placeholder="Poster URL" value="${movie.poster_url}">
